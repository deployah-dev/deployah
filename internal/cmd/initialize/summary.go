...
unchanged into the generated Helm chart's crds/ directory. It reads only
kind and metadata.name for plan output. Helm installs them on a fresh
release unless you pass --skip-crds.
