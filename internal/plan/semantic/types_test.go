...
func TestEnumString(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "modified", got: semantic.DriftModified.String(), want: "modified"},
		{name: "missing", got: semantic.DriftMissing.String(), want: "missing"},
		{name: "unknown drift kind", got: semantic.DriftKind(0).String(), want: "DriftKind(0)"},
		{name: "none", got: semantic.HelmNone.String(), want: "none"},
		{name: "install", got: semantic.HelmInstall.String(), want: "install"},
