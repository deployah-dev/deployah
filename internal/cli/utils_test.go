...
func TestReleaseToViewModel(t *testing.T) {
	...
	t.Run("zero LastDeployed leaves age and timestamp empty", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("non-zero LastDeployed populates timestamp and age", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("empty config yields nil Values", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("non-empty config is preserved", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("labels populate project and environment", func(t *testing.T) {
		t.Parallel()
