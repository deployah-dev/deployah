...
var (
	// versionRegex matches version strings such as "v1-alpha.5", "v1-beta.2",
...
// specific version.
// Version strings should follow the format "v1-alpha.5", "v1-beta.2", etc.
...
// "v1-alpha.5", "v1-beta.2", etc. The schema file must be named
